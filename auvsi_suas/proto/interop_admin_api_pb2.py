...
_MISSIONJUDGEFEEDBACK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='things_fell_off_uas', full_name='auvsi_suas.proto.MissionJudgeFeedback.things_fell_off_uas', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='crashed', full_name='auvsi_suas.proto.MissionJudgeFeedback.crashed', index=8,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='air_drop_accuracy', full_name='auvsi_suas.proto.MissionJudgeFeedback.air_drop_accuracy', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ugv_drove_to_location', full_name='auvsi_suas.proto.MissionJudgeFeedback.ugv_drove_to_location', index=10,
